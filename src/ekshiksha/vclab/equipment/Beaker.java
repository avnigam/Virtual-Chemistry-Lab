...
public class Beaker extends Equipment
{
    ...
    Point2D.Float mouthRight=new Point2D.Float(41,0);
     ...
     */
    public Beaker(int id,String eqname, Point2D.Float origin,float quantity,int size,String contents,Color contentColor,float strength,WorkBench environ)
    {
    ...
    */
    public Beaker(Point2D.Float origin,Cupboard e)
    {
        super("Beaker",origin);
    ...
    public void initEquipment()
    {
        ...
        this.Awidth=((38+(size-1)*2)*w);
        this.width=((40+(size-1)*2)*w);
    ...
    {      
        capacity = 100+(size-1)*50;
	Awidth=(int)((38+(size-1)*2)*w);
        mouthRight=new Point2D.Float(41+(size-1)*2,0);
        ht=(int) ((50+(size-1)*2));
        Awidth=((38+(size-1)*2)*w);
        width=((40+(size-1)*2)*w);
    	...
    	coords.addElement( new Point2D.Float(((mouthRight.x-4)*w), ((mouthRight.y+ht+2) *h)));
    	coords.addElement( new Point2D.Float(((mouthRight.x-3)*w), ((mouthRight.y+ht+1) *h)));
    	coords.addElement( new Point2D.Float(((mouthRight.x-2)*w), ((mouthRight.y+ht) *h)));
    	coords.addElement( new Point2D.Float(((mouthRight.x-2)*w), ((mouthRight.y+2) *h)));
